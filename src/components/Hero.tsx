...
const Hero: React.FC = () => {
    return (
        <section
            id="hero"
            className="relative flex items-center justify-center pb-0 pt-16 md:pt-20 px-5 bg-surface-primary z-20 rounded-t-3xl md:rounded-t-[3rem] shadow-2xl"
        ...
        >
            ...
            <div className="text-center pt-16 md:pt-20">
                <h1 className="text-4xl md:text-5xl md:leading-tight text-foreground max-w-lg md:max-w-2xl mx-auto whitespace-pre-line font-dm-sans">{heroDetails.heading}</h1>
